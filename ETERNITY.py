...
import playsound # for playing an audio
import random 
...
import certifi
import time 
import os # for removing the audio files when necessary
import subprocess
...
def record_audio(ask=""):
    with sr.Microphone() as source: # microphone as source
        ...
        try:
            ...
            engine_speak("Sorry I listened it but cant process as net is down") # error recognizer is not connected
...
def respond(voice_data):
    # 1: greeting
    if there_exists(['hello', 'hi', 'hey', 'hey miss', 'hola', 'hallo']):
        greetings = ["yeah, how can I help you" + person_obj.name, "hey, what's up?" + person_obj.name, "I'm listening" + person_obj.name, "how can I help you?" + person_obj.name, "hello" + person_obj.name]
    ...
    if there_exists(["my name is"]):
        ...
        engine_speak("okh, i will remember that " + person_name)
        person_obj.setName(person_name) # remember name in person object
    
    if there_exists(["your name should be"]):
        asis_name = voice_data.split("be")[-1].strip()
        engine_speak("okh, i will remember that's my name is " + asis_name)
    ...
    if there_exists(["open galiyara"]):
        ...
        webbrowser.get().open(url)
        engine_speak("here's your galiyaara")
        
    #8 time table
    if there_exists(["show my time table"]):
        im = Image.open(r"image.jpeg")
        im.show()
    ...
    if there_exists(["capture","my screen","screenshot"]):
        ...
        myScreenshot.save('/home/windingshelf/Desktop') 
